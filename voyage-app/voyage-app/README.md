...
| **Comparaison visuelle interactive** (nuage de points prix/durée) | Permet de visualiser l'arbitrage prix/temps en un coup d'œil, avec la ligne de budget cible affichée directement sur le graphique. |
